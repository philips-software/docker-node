...
### nodeJS stable
- `node` `node:stable` `node:16` `node:16.2` `node:16.2.0` `node:16.2.0-buster` [16/vanilla/Dockerfile](16/vanilla/Dockerfile)

### nodeJS lts
- `node:lts` `node:14` `node:14.17` `node:14.17.0` `node:14.17.0-buster` [14/vanilla/Dockerfile](14/vanilla/Dockerfile)
...
- `node:java` `node:stable-java` `node:16-java` `node:16.2-java` `node:16.2.0-java` `node:16.2.0-buster-java` [16/java/Dockerfile](16/java/Dockerfile)`

### nodeJS lts with openjdk
- `node:lts-java` `node:14-java` `node:14.17-java` `node:14.17.0-java` `node:14.17.0-buster-slim-java` [14/java/Dockerfile](14/java/Dockerfile)
